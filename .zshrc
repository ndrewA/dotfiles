# Place Fastfetch before the Powerlevel10k instant prompt initialization
...
alias dict='noglob dict_wrapper'
dict_wrapper() { command dict "$*" | less; }
...
alias nvid="neovidecloseterminal"
